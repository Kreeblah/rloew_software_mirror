...
#ifdef DEMO
else printf("\nR. Loew Electronics Drive Partitioning Program Version 1.4 (DEMO)\nCopyright (C) 2008-2009, All Rights Reserved\n\n");
#else
else printf("\nR. Loew Electronics Drive Partitioning Program Version 1.4\nCopyright (C) 2008-2009, All Rights Reserved\n\n");
#endif
...
printf("\nUNWRITTEN CHANGES WILL BE DISCARDED\n\nInstall MultiBoot ? (Y/N/MBR) (N) ");read(0,&l,4);
if (((l&0xdf)-'M') && ((l&0xdf)-'Y')) goto iquit;
if ((l&0xdf)-'M') if (int13(0x43,i,0L,2L,s)) {printf("Error Writing End Sector\n");goto ierr;}
...
case '>': i=strlen(cmd);
          ...
          l=cdisk->partsecs;
          for (ll=0;ll<l;ll++) {
          if (int13(0x42,cdisk->drive,0L,ll,s)) {printf("Error Reading Sector %lx\n",ll);goto sf1;}
...
case '<': i=strlen(cmd);
          ...
          if (int13(0x43,cdisk->drive,0L,ll++,s)) {printf("Error Writing Sector %lx\n",ll-1);goto lf1;}
          }
