...
unsigned long e,l,ll,d[8],mult,xx[4],z;
...
#ifdef DEMO
else printf("\nR. Loew Electronics Drive Partitioning Program Version 2.3 (DEMO)\nCopyright (C) 2008-2010, All Rights Reserved\n\n");
#else
else printf("\nR. Loew Electronics Drive Partitioning Program Version 2.3\nCopyright (C) 2008-2010, All Rights Reserved\n\n");
#endif
...
if (s<mod40) if (e>mod40) goto badr;
