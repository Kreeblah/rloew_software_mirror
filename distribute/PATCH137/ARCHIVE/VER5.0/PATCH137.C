...
0xc7,0x81,0xfc,1,0,0,0,5,0x45,0x44,                  // Set [Sector+1FC] = 44450500
0x59,
// Version 5.0
...
int off[]={0,0xc,0x46,0x5e,0x51,0x5c,0x69};    
#define patchp 0x70
...
char cr[]="                48-Bit LBA Patch 5.0  (DEMO)  Copyright (C) 2003-2006 by Rudolph R. Loew. All Rights Reserved.          ";
