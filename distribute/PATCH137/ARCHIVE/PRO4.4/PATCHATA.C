...
0xc1,0xc0,0x08,0x66,0x8b,0x57,0x45,0xee,0xb0,0x00,0x42,0xee,0x42,0xee,0xc1,0xc8,0x08,0xc3,
// blk 2 calls blk 7
...
0x81,0x7B,0x10,0x1D,0x00,0x00,0x00,0x75,0x1E,      // If Offset 1D
0x81,0x7B,0x04,0x3D,0x00,0x00,0x00,0x75,0x15,      // If Length 3D
0x81,0x3D,0xEC,0x01,0x00,0x00,0x4C,0x52,0x4C,0x52, // If 000001EC = 0x524C524C
0x75,0x09,
0x66,0xC7,0x05,0xEE,0x01,0x00,0x00,0x52,0x4C,      // 000001EE = 0x4C52
...
int off[]={0,0xc,0x26,0x3e,0x31,0x3c,0x49};
#define patchp 0x50

#define psz (sizeof(patch))

char cr[]="                48 Bit LBA Patch 4.4  Copyright (C) 2003-2005 by Rudolph R. Loew. All Rights Reserved.  €€€€€€€€";
...
qupd: printf("Newer Version Found - Downgrade ? (Y/N) ");_read(0,b+32252,4);
