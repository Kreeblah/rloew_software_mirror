...
char cr[]="    48 Bit LBA Patch 1.0    Copyright (C) 2003-2004 by Rudolph R. Loew. All Rights Reserved.    ";
...
int e,f,ff,ver;
char bb[512],bbb[512];
printf("\n48 Bit LBA Patch\n\nCopyright (C) 2004 by Rudolph R. Loew, All Rights Reserved.\n\n");
e=20;ver=0;
if (c>1) {
...
fs+=0x98-strlen(cr);j=fs;chsize(f,j);j=strlen(bb);
if (j>4) if (bb[j-4]=='.') {
...
chk: if (ver) if (e) {printf("Press Enter To Continue \n");_read(0,bb,4);}
return(e);
}
