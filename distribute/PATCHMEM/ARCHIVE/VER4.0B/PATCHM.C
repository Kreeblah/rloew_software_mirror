...
long vcksm[]={0xb2a9e5f5,0xa865e82d,
              ...
              0xb7cb39e7,0x0712be02,0x42e9a7b0,
...
long ccksm[]={0xc4ccba40,0xe358f06f,0x8d33f070,0xd7571fdb,
...
if ((c>1) && (c-5)) {printf("PATCHMEM [+MAXCACHE] [#Ring3] [VMM32File VMMFile VCACHEFile HimemFile]\n");return(20);}
printf("\nWindows 98/SE/ME RAM Limitation Patch  Version 4.0 RRL (BETA)\nCopyright (C) 2007-2008 by Rudolph R. Loew. All Rights Reserved.\n\n");
#endif
