...
#ifdef SELF
char cr[]="                Windows 9X RAM Limitation Patch 4.0 Copyright (C) 2007-2008 by Rudolph R. Loew. All Rights Reserved.        ";
#endif
...
#ifdef DEMO
char cr[]="                Windows 9X RAM Limitation Patch 4.0  (DEMO) Copyright (C) 2007-2008 by Rudolph R. Loew. All Rights Reserved.";
#endif
...
// Tail Space Entry: Set to Type 6 on Upgrades Only
...
0xba,1,0xc1,6,0x10,0,0,0,0x90,0xa6,0xc2,2,1,0,0xc0,0xa4,
...
0xc1,1,0xa0,0x86,0xdd,0x36,-1,0
};
...
0x80,0x77,2,0xc1,1,0xa,0xc0,0x29,0xc1,1,0xa0,0x86,0xdd,0x36,-1,0
};


char vc1998[]={
0xc0,0x7c,0xc1,4,0x52,0x52,0x4c,0x20,0x80,0xa5,0x5c,0xc1,2,0x20,1,0xc0,
5,0xc1,2,0x20,1,0x86,0xd0,0x31,-1,0
};

char vc2183[]={
0xc0,0x7c,0xc1,4,0x52,0x52,0x4c,0x20,0x80,0xa5,0x5c,0xc1,2,0x20,1,0xc0,
5,0xc1,2,0x20,1,0x86,0x11,0x34,-1,0
};
...
5,0xc1,2,0x20,1,0x86,0xf7,2,-1,0
};
...
char vc98[]={
0xc0,0x7c,0xc1,4,0x52,0x52,0x4c,0x20,0x80,0xa5,0x5c,0xc1,2,0x20,1,0xc0,
5,0xc1,2,0x20,1,0x86,0xf9,0x33,-1,0
};
...
char vcme[]={
0xc0,0xc4,0xc1,4,0x52,0x52,0x4c,0x22,0x80,0xee,0x80,0xc1,2,0xa0,1,0xc0,
5,0xc1,2,0xa0,1,0x86,0x2a,5,-1,0
};

#endif

long vcksm[]={0xb2a9e5f5,0xa865e82d,
              0xbec8673c,0x3d54192d,0x3929dff5,0x6f059bfc,
              0xb7cb39e7,0x0712be02,0x42e9a7b0,       // VMM.VXD

#ifdef CAB
              0xb2a9e1f5,0xbec8633c,0xb7cb35e7,       // VMM32.VXD
#endif

              0};

long ccksm[]={0xc4ccba40,0xe358f06f,
              0x8d33f070,
              0xd7571fdb,                             // VCACHE.VXD

#ifdef CAB
              0x1af1ba3f,0xe358f06f,0x3293b2f5,       // VCACHE.VXD
#endif

              0};

long hcksm[]={0x9c872941,0x9c882d41,0};

long vmask1[]={0,0xc600,0xf600,0x104dc,0x10510,0x30e00,0x32e00,0x3ce00,0x3de00,0x100000,0,0};
long vmask2[]={0,0xc600,0xf600,0xf8bc,0xf910,0x30200,0x32200,0x3c200,0x3d200,0x73400,0,0};
long vmask3[]={0,0xc900,0xf900,0xfabc,0xfb10,0x31400,0x33400,0x3d400,0x3e400,0x74600,0,0};
long vmask4[]={0,0xac00,0xcc00,0xd4bc,0xd510,0xd644,0xd648,0x2ea00,0x2fa00,0x39a00,0x3aa00,0x4da00,0x4ea00,0x100000,0,0};
long vmask5[]={0,0xac00,0xcc00,0xccc4,0xcd18,0xcd4c,0xce50,0x2f000,0x30000,0x3a000,0x3b000,0x4e000,0x4f000,0x72e00,0,0};

long cmask1[]={0,0x13c,0x160,0xc00,0x1c00,0x2c00,0x3c00,0x8f00,0,0};
long cmask2[]={0,0x13c,0x178,0xc00,0x1c00,0x4c00,0x5c00,0x8f00,0,0};
long cmask3[]={0,0x184,0x1c0,0x1000,0x2000,0x5000,0x6000,0x84c0,0,0};

long hmask[]={0,0x7c20,0,0};
...
case 5: readd(b2,1);
        ...
        goto lp;
case 6: while(j=_read(f1,b,8192)) {
        if (_write(f3,b,j)<j) goto werr;
        }
        goto lp;
...
while(x-y) {
i=y-x;
if (y>(x+0x6000)) i=0x6000;
j=_read(f,b,i);j&= -4;
for (k=0;k<j;k+=4) z+= *(long *)(b+k);
if (j-i) return(z);
x+=i;
};
goto lp;
...
#ifdef CAB
*(int *)(vc98+0xd)= *(int *)(vc98+0x13)=max^0x320;
*(int *)(vcse+0xd)= *(int *)(vcse+0x13)=max^0x320;
*(int *)(vcme+0xd)= *(int *)(vcme+0x13)=max^0x320;
#endif

#ifdef SELF
if (c>1) if (v[1][0]=='#') {r3++;c--;v++;}
if (c>1) if (v[1][0]=='=') {au++;c--;v++;}
if ((c>1) && (c-5)) {printf("PATCHMEM [+MAXCACHE] [#Ring3] [=AutoUnInst] [VMM32File VMMFile VCACHEFile HimemFile]\n");return(20);}
printf("\nWindows 98/SE/ME RAM Limitation Patch  Version 4.0 RRL\nCopyright (C) 2007-2008 by Rudolph R. Loew. All Rights Reserved.\n\n");
#endif

#ifdef PRO
if ((c>1) && (c-5)) {printf("PATCHMEM [+MAXCACHE] [VMM32File VMMFile VCACHEFile HimemFile]\n");return(20);}
printf("\nWindows 98/SE/ME RAM Limitation Patch  Version 4.0\nCopyright (C) 2007-2008 by Rudolph R. Loew. All Rights Reserved.\n\n");
#endif

#ifdef CAB
#ifndef SELF
if ((c>1) && (c-5)) {printf("PATCHMEM [+MAXCACHE] [VMM32File VMMFile VCACHEFile HimemFile]\n");return(20);}
printf("\nWindows 98/SE/ME RAM Limitation Patch  (CAB)  Version 4.0\nCopyright (C) 2007-2008 by Rudolph R. Loew. All Rights Reserved.\n\n");
#endif
#endif

#ifdef DEMO
if ((c>1) && (c-5)) {printf("PATCHM [+MAXCACHE] [VMM32File VMMFile VCACHEFile HimemFile]\n");return(20);}
printf("\nWindows 98/SE/ME RAM Limitation Patch  (DEMO)  Version 4.0\nCopyright (C) 2007-2008 by Rudolph R. Loew. All Rights Reserved.\n\n");
#endif
...
if (exist&0x20) {
printf("VMM File Updated by Other Program\n");
...
if (exist&0x200) {
printf("VCACHE File Updated by Other Program\n");
...
if (exist&0x2000) {
printf("HIMEM File Updated by Other Program\n");
...
i=_read(f,b,0x6000);
if (i<0x5000) goto bad;
if ((*(long *)(b+0x40ca))==0x2e061e60) {
rel=rel98;reloff=0x3ea2;memcpy(subr,b+0x40a2,2792);goto ok;
}
if ((*(long *)(b+0x4242))==0x2e061e60) {                       // 2225
rel=rel98;reloff=0x401a;memcpy(subr,b+0x421a,2792);goto ok;
}
...
_close(f2);
vmm1998[5]|=0x10;vmm1999[5]|=0x10;
vmm2222[5]|=0x10;vmm2223[5]|=0x10;vmm2225[5]|=0x10;vmm2226[5]|=0x10;
vmm3000[5]|=0x10;vmm3002[5]|=0x10;vmm3003[5]|=0x10;
exist|=0x10;printf("VMM File Extracted\n");
}
...
_close(f2);
vc1998[7]|=0x10;vc2183[7]|=0x10;vc2222[7]|=0x10;vc3000[7]|=0x10;

#ifdef CAB
vc98[7]|=0x10;vcse[7]|=0x10;vcme[7]|=0x10;
#endif
...
case 0x10400: y=cksm(f,vmask1);break;
case 0xf800: y=cksm(f,vmask2);break;
case 0xfa00: y=cksm(f,vmask3);break;

#ifdef SELF
case 0xd000:
#endif

case 0xd400: y=cksm(f,vmask4);break;
case 0xcc08: y=cksm(f,vmask5);
};
}
_close(f);
ckv= -1;
...
if (_read(f,b,512)==512) {
switch(*(long *)(b+0x170)) {
case 0x444f434d: y=cksm(f,cmask1);break;
case 0x434f4244: y=cksm(f,cmask2);break;

#ifdef SELF
case 0: y=cksm(f,cmask3);
#endif
...
if (ckc==2) {
lseek(f,0x13cL,0);
if (_read(f,&z,4)<4) {printf("Read Error\n");goto uninst;}
lseek(f,0L,0);
if (z==0x20c) ckc=1;
}
f2=_creat(cname,0);
...
#ifdef CAB
case 4: a=dmake(f,vc98,f2);i=1998;break;
case 5: a=dmake(f,vcse,f2);i=2222;break;
case 6: a=dmake(f,vcme,f2);i=3000;break;
#endif

};
_close(f);_close(f2);
if (a) {printf("VCACHE Patch Error: %s\n");goto uninst;}
printf("VCACHE Version %d Patched\n",i);
}
exist&=0xf7ff;
...
exist|=0x2000;
if (_read(f,b,0x6000)<0x6000) goto undohir;
if (_write(f2,b,0x6000)<0x6000) goto undohiw;
if ((i=_read(f,b,0x6000))<0x993) goto undohir;
if (b[0x992]-0x30) goto undohir;
b[0x992]=0x50;
if (_write(f2,b,i)<i) goto undohiw;
switch(ckh) {
case 0: i=7;break;
case 1: i=8;break;
};
_close(f);_close(f2);printf("HIMEM DOS-%d Version Patched\n",i);
}
exist&=0x7fff;
...
undohir: printf("Invalid HIMEM File\n");goto uninst;
undohiw: printf("Error Writing HIMEM File\n");goto uninst;
}
