...
int len;
long addr,*cmd;
} listx[9],listv[31],listc[4];

#ifdef SELF
char cr[]="                Windows 9X RAM Limitation Patch 6.2 Copyright (C) 2007-2009 by Rudolph R. Loew. All Rights Reserved.        ";
#endif
...
#ifdef DEMO
char cr[]="                Windows 9X RAM Limitation Patch 6.2  (DEMO) Copyright (C) 2007-2009 by Rudolph R. Loew. All Rights Reserved.";
#endif
...
char dmemd[]={0x83,0x7F,0x0A,0x04,0x0F,0x85,0xF0,0xFE,
0x83,0x7F,0x08,0x02,0x0F,0x82,0xE8,0xFE,0x66,0xF7,0x47,0x10,0x00,0x80,0x00,0x00
};

long dmemc[]={0,0xac66fffe,4,0x821cecf1,8,0xfeb7f1fc,12,0x809a8464,
16,0xd02d0da4,20,0x8010c7f6,0,0
};
...
{0,0,0,-1,lenc},
{tab1d,msk24,12,-1,tab1c},
{tab2ad,tab2am,62,-1,tab2ac},
{cmtd,msk24,12,-1,cmtc},
{tab2bd,msk24,16,-1,tab2bc},
{flgd,flgm,35,-1,flgc},
{pat98d,0,-16,-1,0},

#ifdef DEMO
{demojd,msk24,7,-1,demojc},
{demopd,msk24,20,-1,demopc},
#endif
...
{mtab1d,msk24,10,-1,mtab1c},
{mtab2ad,mtab2am,112,-1,mtab2ac},
{mcmtd,msk24,7,-1,mcmtc},
{mtab2bd,msk24,14,-1,mtab2bc},
...
#ifdef SELF
struct info win98r3[]={
{ring31d,msk24,11,-1,ring31c},
{ring32d,msk24,8,-1,ring32c},
{ring33d,msk24,9,-1,ring33c},
{ring34d,msk24,12,-1,ring34c},
{ring35d,msk24,13,-1,ring35c},
{ring36d,msk24,8,-1,ring36c},
{ring37d,msk24,13,-1,ring37c},
{ring38d,msk24,7,-1,ring38c},
{0,0,0,0,0}
};

struct info winmer3[]={
{ring31md,msk24,11,-1,ring31mc},
// {ring32md,msk24,7,-1,ring32mc},
{ring33md,msk24,8,-1,ring33mc},
{ring34md,msk24,9,-1,ring34mc},
{0,0,0,0,0}
};
#endif

struct info prothk[]={             // Order must be maintained  Ref  0,1,2
{prothk1d,msk24,6,-1,prothk1c},
...
{mem02d,msk24,6,-1,mem02c},
{mpad,msk24,8,-1,noch},
{memp01,0,-49,-1,0},

#ifdef DEMO
{dmemd,msk24,24,-1,dmemc},
#endif
...
if (m16) {
if (build(&mem,list,cnt)) goto bad1;
...
#ifdef SELF
printf("\nWindows 98/SE/ME RAM Limitation Patch  Version 6.2 RRL\nCopyright (C) 2007-2009 by Rudolph R. Loew. All Rights Reserved.\n\n");
#endif

#ifdef PRO
printf("\nWindows 98/SE/ME RAM Limitation Patch  Version 6.2\nCopyright (C) 2007-2009 by Rudolph R. Loew. All Rights Reserved.\n\n");
#endif

#ifdef DEMO
printf("\nWindows 98/SE/ME RAM Limitation Patch  (DEMO)  Version 6.2\nCopyright (C) 2007-2009 by Rudolph R. Loew. All Rights Reserved.\n\n");
#endif
