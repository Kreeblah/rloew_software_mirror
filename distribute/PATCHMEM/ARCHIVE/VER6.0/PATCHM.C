...
int len;
long addr,*cmd;
} listx[8],listv[28],listc[4];

#ifdef SELF
char cr[]="                Windows 9X RAM Limitation Patch 6.0 Copyright (C) 2007-2009 by Rudolph R. Loew. All Rights Reserved.        ";
#endif
...
#ifdef DEMO
char cr[]="                Windows 9X RAM Limitation Patch 6.0  (DEMO) Copyright (C) 2007-2009 by Rudolph R. Loew. All Rights Reserved.";
#endif
...
#endif
        printf("Options:  /C:#  Set Absolute Max File Cache (MB)\n");
...
#ifdef SELF
        printf("          /R    Enable Ring 3 Access to all Memory\n");
...
#ifdef SELF
printf("\nWindows 98/SE/ME RAM Limitation Patch  Version 6.0 RRL\nCopyright (C) 2007-2009 by Rudolph R. Loew. All Rights Reserved.\n\n");
#endif

#ifdef PRO
printf("\nWindows 98/SE/ME RAM Limitation Patch  Version 6.0\nCopyright (C) 2007-2009 by Rudolph R. Loew. All Rights Reserved.\n\n");
#endif

#ifdef DEMO
printf("\nWindows 98/SE/ME RAM Limitation Patch  (DEMO)  Version 6.0\nCopyright (C) 2007-2009 by Rudolph R. Loew. All Rights Reserved.\n\n");
#endif
