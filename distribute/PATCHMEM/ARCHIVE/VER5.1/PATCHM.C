...
#ifdef SELF
char cr[]="                Windows 9X RAM Limitation Patch 5.1 Copyright (C) 2007-2008 by Rudolph R. Loew. All Rights Reserved.        ";
#endif
...
#ifdef DEMO
char cr[]="                Windows 9X RAM Limitation Patch 5.1  (DEMO) Copyright (C) 2007-2008 by Rudolph R. Loew. All Rights Reserved.";
#endif
...
char pat98d[]={0x05,0x00,0x00,0x00,0x00,0x50,0xE8,0x00,0x00,0x00,0x00,0xE9,0x00,0x00,0x00,0x00};
...
if (c>1) if (v[1][0]=='+') {maxc=getnum(v[1]+1);c--;v++;}

#ifdef SELF
if (c>1) if (v[1][0]=='#') {r3++;c--;v++;}
if (c>1) if (v[1][0]=='=') {au++;c--;v++;}
if ((c>1) && (c-4)) {printf("PATCHMEM [+MAXCACHE] [#Ring3] [=AutoUnInst] [VMM32File VMMFile VCACHEFile]\n");return(20);}
printf("\nWindows 98/SE/ME RAM Limitation Patch  Version 5.1 RRL\nCopyright (C) 2007-2008 by Rudolph R. Loew. All Rights Reserved.\n\n");
#endif

#ifdef PRO
if ((c>1) && (c-4)) {printf("PATCHMEM [+MAXCACHE] [VMM32File VMMFile VCACHEFile]\n");return(20);}
printf("\nWindows 98/SE/ME RAM Limitation Patch  Version 5.1\nCopyright (C) 2007-2008 by Rudolph R. Loew. All Rights Reserved.\n\n");
#endif

#ifdef DEMO
if ((c>1) && (c-4)) {printf("PATCHM [+MAXCACHE] [VMM32File VMMFile VCACHEFile]\n");return(20);}
printf("\nWindows 98/SE/ME RAM Limitation Patch  (DEMO)  Version 5.1\nCopyright (C) 2007-2008 by Rudolph R. Loew. All Rights Reserved.\n\n");
#endif
...
i=procv(f,0x20);
switch(i) {
case 5: rel=rel98;break;
case 6: rel=relme;break;
