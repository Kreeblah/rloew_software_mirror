...
#ifdef SELF
char cr[]="                Windows 9X RAM Limitation Patch 5.0 Copyright (C) 2007-2008 by Rudolph R. Loew. All Rights Reserved.        ";
#endif
...
#ifdef DEMO
char cr[]="                Windows 9X RAM Limitation Patch 5.0  (DEMO) Copyright (C) 2007-2008 by Rudolph R. Loew. All Rights Reserved.";
#endif
