...
#ifdef SELF
char cr[]="                Windows 9X RAM Limitation Patch 7.0 Copyright (C) 2007-2010 by Rudolph R. Loew. All Rights Reserved.        ";
#endif
...
#ifdef DEMO
char cr[]="                Windows 9X RAM Limitation Patch 7.0  (DEMO) Copyright (C) 2007-2010 by Rudolph R. Loew. All Rights Reserved.";
#endif
...
y=mem9x[2].addr-mem9x[0].addr-5;y=0x900000e8+(y<<8);mem01c[1]=y;
y=mem9x[2].addr-mem9x[1].addr+16;y=(y<<8)-0xc9327e;mem02c[1]=y;
mem9x[2].addr-=64;
}
else {
scan(f,buff,&mem95);
...
if (_read(f,&c,2)<2) goto rerr;
*(int *)(memp01+8)= *(int *)(memp01+16)= *(int *)(memp01+26)=c;
y=mem95[2].addr-mem95[0].addr-5;y=0x900000e8+(y<<8);mem01c[1]=y;
y=mem95[2].addr-mem95[1].addr+16;y=(y<<8)-0xc9327e;mem02c[1]=y;
mem95[2].addr-=64;
}
...
if (m==1) if (build(&realm98,list,cnt)) goto bad1;
if (m==3) if (build(&realm95,list,cnt)) goto bad1;
if (m16) if (build((m==3) ? &mem95 : &mem9x,list,cnt)) goto bad1;

#ifdef DEMO
if (m16) if (build(&dlock,list,cnt)) goto bad1;
#endif
...
#ifdef SELF
printf("\nWindows 95/98/SE/ME RAM Limitation Patch  Version 7.0 RRL\nCopyright (C) 2007-2010 by Rudolph R. Loew. All Rights Reserved.\n\n");
#endif

#ifdef PRO
printf("\nWindows 95/98/SE/ME RAM Limitation Patch  Version 7.0\nCopyright (C) 2007-2010 by Rudolph R. Loew. All Rights Reserved.\n\n");
#endif

#ifdef DEMO
printf("\nWindows 95/98/SE/ME RAM Limitation Patch  (DEMO)  Version 7.0\nCopyright (C) 2007-2010 by Rudolph R. Loew. All Rights Reserved.\n\n");
#endif
