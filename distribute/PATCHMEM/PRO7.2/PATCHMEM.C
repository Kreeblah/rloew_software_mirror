...
int len;
long addr,*cmd;
} listx[10],listv[34],listc[4];

#ifdef SELF
char cr[]="                Windows 9X RAM Limitation Patch 7.2 Copyright (C) 2007-2017 by Rudolph R. Loew. All Rights Reserved.        ";
#endif
...
#ifdef DEMO
char cr[]="                Windows 9X RAM Limitation Patch 7.2  (DEMO) Copyright (C) 2007-2013 by Rudolph R. Loew. All Rights Reserved.";
#endif
...
long mgetc98[]={1,0x80,-6,0x74c00966,-10,0xc1896613,-14,0x90c28966,21,0x80,0,0};

long mgetc95[]={1,0x80,-6,0x740000e8,-10,0xc1896613,-14,0x90c28966,21,0x80,0xbc,-2,0,0};
long mgetc95v[]={1,0x80,-6,0x740000e8,-10,0xc1896613,-14,0x90c28966,21,0x80,0xbc,-2,0,0};
char madj[]={0x66,0x3D,0xFF,0xFF,0x03,0x00,0x72,0x06,0x66,0xB8,0xFF,0xFF,0x03,0x00,0x66,0x09,0xC0,0xC3};

char sigvd[]={0x52,0x52,0x4C,0x00};

char sigxd[]={0x52,0x52,0x4C,0x00};

long lenc98[]={0,0x91e4,0,0};

long lenc95[]={0,0x14f70,0,0};

char tab198d[]={0x3d,0x34,0x08,0x00,0x00,0x72,0x05,0xb8,0x34,0x08,0x00,0x00};
long tab198c[]={1,0x65c,8,0x65c,0,0};

char tab195d[]={0x3d,0xe8,0x03,0x00,0x00,0x72,0x05,0xb8,0xe8,0x03,0x00,0x00};
long tab195c[]={1,0xaa8,8,0xaa8,0,0};

char tab1p95d[]={
0x81,0xfe,0x00,0x00,0x00,0x00,0x73,0x00,0xa1,0x00,0x00,0x00,0x00,
0x6b,0xc0,0x0d,0x8b,0x0d,0x00,0x00,0x00,0x00,0x8d,0x90,0x00,0x00,0x00,0x00
};

char tab1p95m[]={
0xff,0xff,0x00,0x00,0x00,0x00,0xff,0x00,0xff,0x00,0x00,0x00,0x00,
...
long tab298ac[]={4,0x3f00,12,0x3f00,52,0x50,57,1,-58,-1    ,0,0};
// JMP pat9x

char tab295ad[]={
0xC7,0x44,0x24,0x10,0xD8,0x27,0x00,0x00,0xC7,0x44,0x24,0x14,0xD8,0x27,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x68,0x00,0x00,0x00,0x00,0xE8,0x00,
0x00,0x00,0x00
};
...
long tab295ac[]={4,0x69f8,12,0x69f8,41,0x50,46,1,-47,-1    ,0,0};
// JMP pat9x

char cmt98d[]={0x68,0x08,0x00,0x02,0x20,0x6a,0x00,0x6a,0x04,0x6a,0x06,0x8b};
long cmt98c[]={9,0x400,0,0};

char cmt95d[]={0x68,0x08,0x00,0x02,0x20,0x6a,0x00,0x6a,0x04,0x6a,0x03,0x8b};
long cmt95c[]={9,0x700,0,0};

char tab298bd[]={0xC7,0x44,0x24,0x30,0x00,0x00,0xA0,0x00,0xC7,0x44,0x24,0x2C,0x00,0x60,0x00,0x00};
long tab298bc[]={12,0x4000,0,0};

char tab295bd[]={0xC7,0x44,0x24,0x2C,0x00,0x30,0x00,0x00,0xC7,0x44,0x24,0x30,0x00,0x00,0xa0,0x00};
long tab295bc[]={4,0x7000,0,0};
...
0xFF,0xFF,0x00,0x00,0x00,0x00,0xFD,0xFF,0x00,0x00,0x00,0x00,0xFE,0xFF,0xFF,0x00,
0x00,0x00,0x00
};
...
char demo95jd[]={0xcd,0x20,0x01,0x00,0x05,0x00,0x8b,0x05};
long demo95jc[]={0,0x1b,-1,-1  ,5,0x90,0,0};
// 3 CALL DEMOP9XD
...
long demop9xc[]={0,0x9c94bb76,4,0x679296,8,0xdae0915b,12,0xe980d8ca,16, 0x4e9c0d9c,0,0};

char demop95d[]={
0x42,0x55,0x47,0x3a,0x20,0x20,0x54,0x68,0x72,0x65,0x61,0x64,0x20,0x75,0x73,0x69,
0x6e,0x67,0x20,0x6d
};
long demop95c[]={0,0xc5b9cb8b,4,0xb878dfe5,8,0x9b9f9b5d,12,0xa0808b1d,16, 0x56de0b92,0,0};
#endif
...
char ring38d[]={0x77,0x00,0x68,0x08,0x00,0x02,0x20};

char ring38m[]={0xff,0x00,0xff,0xff,0xff,0xff,0xff};
...
char ring9532d[]={0xC7,0x44,0x24,0x20,0x08,0x00,0x02,0x20};
char ring9535d[]={0x00,0x00,0x68,0x08,0x00,0x02,0x20,0x6A,0x00,0x6A,0x04,0x6A,0x03};
...
char agp981d[]={0xbd,0x00,0x00,0x0c,0x00};
char agp982d[]={
0xbd,0x00,0x00,0x0c,0x00,0xa8,0x08,0x75,0x0f,
0x81,0x7c,0x24,0x40,0x00,0x80,0x00,0x00,0x72,0x05,0xbd,0x00,0x00,0x08,0x00,0xc3
};
long agp981c[]={0,0x2B,-1,-1   ,0,0};

char agp951d[]={0xbb,0x00,0x00,0x0c,0x00};
char agp952d[]={
0xbb,0x00,0x00,0x0c,0x00,0xa8,0x08,0x75,0x0f,
0x81,0x7c,0x24,0x40,0x00,0x80,0x00,0x00,0x72,0x05,0xbb,0x00,0x00,0x08,0x00,0xc3
};
long agp951c[]={0,0x2D,-1,-1   ,0,0};
...
char memp01v[]={0x50,0xb4,0x09,0xba,0x00,0x3c,0xff,0x1e,0x00,0x00,0xe8,0x13,0x00,0x58,0xff,0x1e,0x00,0x00,0xc3,
0xe8,0x0a,0x00,0xb4,0x0a,0xff,0x1e,0x00,0x00,0x66,0x31,0xc9,0xc3,
0xe8,0x03,0x00,0xc3,0x00,0x00,0x58,0x50,0x53,0x89,0xc3,0x2e,0x87,0x57,0x01,0x5b,0xc3
};
//+8 +10 +1A <- HIMEM PTR.W
...
char wksp[]={0xff,0x01,0x00,0x00,0x00,0x00,0x7f,0x02};

char wkspv[]={0xff,0x01,0x00,0x00,0x00,0x00,0x7f,0x02};

#ifdef DEMO

char dlockad[]={0x66,0x2e,0x89,0x1e};
long dlockac[]={0,-0x880000,0,0};

char dlockbd[]={0x66,0xff,0x2e,0,0,0,0,0,0,0x28,0};
char dlockbm[]={0xff,0xff,0xff,0,0,0xff,0xff,0xff,0xff,0xff,0xff};
long dlockbc[]={5,1,0,0};
...
{0,0,0,-1,lenc98},
{tab198d,msk20,12,-1,tab198c},
{tab298ad,tab298am,62,-1,tab298ac},
{cmt98d,msk20,12,-1,cmt98c},
{tab298bd,msk20,16,-1,tab298bc},
{flgd,flgm,35,-1,flgc},
{pat9xd,0,-16,-1,0},

#ifdef DEMO
{demojd,msk20,7,-1,demojc},
{demop9xd,msk20,20,-1,demop9xc},
#endif
...
struct info win95[]={             // Order must be maintained  Ref  0,2,5,6,7,8 / 9,10
{0,0,0,-1,lenc95},
{tab195d,msk20,12,-1,tab195c},
{tab295ad,tab295am,51,-1,tab295ac},
{cmt95d,msk20,12,-1,cmt95c},
{tab295bd,msk20,16,-1,tab295bc},
{pat9xd,0,-16,-1,0},
{(char *)(&table95a),0,-2,-1,0},
{(char *)(&table95b),0,-2,-1,0},
{tab1p95d,tab1p95m,28,-1,noch},

#ifdef DEMO
{demo95jd,msk20,8,-1,demo95jc},
{demop95d,msk20,20,-1,demop95c},
#endif
...
struct info realm98[]={
{mgetd,mgetm,22,-1,mgetc98},
{0,0,0,0,0}
};

struct info realm98v[]={
{mgetd,mgetm,22,-1,mgetc98},
{0,0,0,0,0}
};

struct info realm95[]={           // Order must be maintained  Ref  1,2
{mgetd,mgetm,22,-1,mgetc95},
{wksp,msk20,8,-1,noch},
{madj,0,-18,-1,0},
{0,0,0,0,0}
};

struct info realm95v[]={           // Order must be maintained  Ref  1,2
{mgetd,mgetm,22,-1,mgetc95v},
{wkspv,msk20,8,-1,noch},
{madj,0,-18,-1,0},
{0,0,0,0,0}
};
...
{ring38d,ring38m,7,-1,ring38c},
{0,0,0,0,0}
};

struct info win95r3[]={
{ring31d,msk20,11,-1,ring31c},
{ring9532d,msk20,8,-1,ring32c},
{ring33d,msk20,9,-1,ring33c},
{ring34d,msk20,12,-1,ring34c},
{ring9535d,msk20,13,-1,ring35c},
{ring36d,msk20,8,-1,ring36c},
{ring37d,msk20,13,-1,ring37c},
{ring38d,ring38m,7,-1,ring38c},
{0,0,0,0,0}
...
struct info agp98[]={                // Order must be maintained  Ref  0,1,2
{0,0,0,-1,agplenc},
{agp981d,msk20,5,-1,agp981c},
{agp982d,0,-25,-1,0},
{0,0,0,0,0}
};

struct info agp95[]={                // Order must be maintained  Ref  0,1,2
{0,0,0,-1,agplenc},
{agp951d,msk20,5,-1,agp951c},
{agp952d,0,-25,-1,0},
{0,0,0,0,0}
};
...
#ifdef DEMO
struct info dlink[]={              // Order must be maintained  Ref 0
{0,0,0,-1,dlinkc},
{0,0,0,0,0}
};
#endif
...
struct info mem9x[]={               // Order must be maintained  Ref 2,3
...
struct info mem9xv[]={               // Order must be maintained  Ref 2,3
{mem01d,mem01m,9,-1,mem01cv},
{mem02d,msk20,6,-1,mem02cv},
{mpad,msk20,8,-1,noch},
{memp01v,0,-49,-1,0},
{0,0,0,0,0}
};

struct info mem95[]={               // Order must be maintained  Ref 2,3
{mem01d,mem01m,9,-1,mem01c},
{mem02d,msk20,6,-1,mem02c},
{wksp,msk20,8,-1,noch},
{memp01,0,-49,-1,0},
...
struct info mem95v[]={               // Order must be maintained  Ref 2,3
{mem01d,mem01m,9,-1,mem01cv},
{mem02d,msk20,6,-1,mem02cv},
{wkspv,msk20,8,-1,noch},
{memp01v,0,-49,-1,0},
...
#ifdef DEMO
struct info dlock[]={
{dlockad,msk20,4,-1,dlockac},
{dlockbd,dlockbm,11,-1,dlockbc},
{0,0,0,0,0}
};
...
switch (b[0]&65535) {
case 0x3357: sigs[0].addr=x-4;x+=0x400;

#ifdef DEMO
             if (m16) dlink[0].addr=x+28;
#endif

             break;
case 0x454c: sigs[0].addr=x-4;
...
b=buff+i-0x28;j=0;
while(comp9x[j]) (*(int *)(b+comp9x[j++]))-=i;
x=0;
for (j=0;j<2792;j+=4) x+= *(long *)(b+j);
j=0;
while(comp9x[j]) (*(int *)(b+comp9x[j++]))+=i;
if (x==0xaaca1cbd) {j=1;goto ok;}
if (x==0x9ac60ab7) {j=3;goto ok;}
j=0;
...
ok: reloff=i-0x228;
if (j==3) reloff-=0x200;
memcpy(subr,buff+i-0x28,2792);return(j);
}
...
c+=e+base;relptr=c-0x1000;lseek(f,c,0);
...
case 8:    c= *(unsigned int *)(b+i+2);
           ...
           if (b[i+4]-mnum) return(-10);
           relptr+=i+5;return(*(unsigned int *)(b+i+5));
case 0x27:
case 0x28: for (j=0;j<b[i+2];j++) {
           c= *(unsigned int *)(b+i+6+j+j);
           if (a-c) goto next2;
           if (b[i+3]-mnum) return(-10);
           relptr+=i+4;return(*(unsigned short *)(b+i+4));
           next2:;
           }
           i+=6+j+j;goto next;
default: return(-1);
...
m=comp(f);
if ((m-1)&0xfffc) return(-1);
x=getic(f,buff,&y,&z,0);
if (x== -4) {
if (m16) {
if (m-3) {
scan(f,buff,&mem9xv);
if (mem9xv[2].addr== -1) return(-2);
if (mem9xv[2].addr>0xffff) return(-2);
mem9xv[3].addr=mem9xv[2].addr;
lseek(f,mem9xv[0].addr+4,0);
if (_read(f,&c,2)<2) goto rerr;
*(int *)(memp01v+8)= *(int *)(memp01v+16)= *(int *)(memp01v+26)=c;
a=mem9xv[2].addr-mem9xv[0].addr-5;mem01cv[1]=0x900000e8+(a<<8);
a=mem9xv[2].addr-mem9xv[1].addr+16;mem02cv[1]=(a<<8)-0xc9327e;
mem9xv[2].addr-=64;
}
else {
scan(f,buff,&mem95v);
if (mem95v[2].addr== -1) {reset1(&mem95v);wkspv[0]^=8;scan(f,buff,&mem95v);}
if (mem95v[2].addr== -1) return(-2);
mem95v[2].addr=mem95v[3].addr=mem95v[2].addr+0x2c6;
lseek(f,mem95v[0].addr+4,0);
if (_read(f,&c,2)<2) goto rerr;
*(int *)(memp01v+8)= *(int *)(memp01v+16)= *(int *)(memp01v+26)=c;
a=mem95v[2].addr-mem95v[0].addr-5;mem01cv[1]=0x900000e8+(a<<8);
a=mem95v[2].addr-mem95v[1].addr+16;mem02cv[1]=(a<<8)-0xc9327e;
mem95v[2].addr-=64;
}

#ifdef DEMO
c=scan(f,buff,&dlockv);
if (c) return(-2);
#endif

}
if (m==1) {
c=scan(f,buff,&realm98v);
if (c) return(-2);
}
if (m==3) {
c=scan(f,buff,&realm95v);
if (c) {reset1(&realm95v);wkspv[0]^=8;c=scan(f,buff,&realm95v);}
if (c) return(-2);
if (realm95v[1].addr>0xffff) return(-2);
realm95v[2].addr=realm95v[1].addr+0x304;
mgetc95v[3]=(mgetc95v[3]&0xff0000ff)+((realm95v[2].addr-realm95v[0].addr-9)<<8);
}
cnt=&cntx;list=listx;*cnt=0;sigxd[3]=tag+(m&2);
if (m==1) if (build(&realm98v,list,cnt)) goto bad1;
if (m==3) if (build(&realm95v,list,cnt)) goto bad1;
if (m16) if (build((m==3) ? &mem95v : &mem9xv,list,cnt)) goto bad1;

#ifdef DEMO
if (m16) if (build(&dlockv,list,cnt)) goto bad1;
#endif
...
if (m-3) {
scan(f,buff,&mem9x);
if (mem9x[2].addr== -1) return(-2);
if (mem9x[2].addr>0xffff) return(-2);
mem9x[3].addr=mem9x[2].addr;
lseek(f,mem9x[0].addr+4,0);
if (_read(f,&c,2)<2) goto rerr;
*(int *)(memp01+8)= *(int *)(memp01+16)= *(int *)(memp01+26)=c;
a=mem9x[2].addr-mem9x[0].addr-5;mem01c[1]=0x900000e8+(a<<8);
a=mem9x[2].addr-mem9x[1].addr+16;mem02c[1]=(a<<8)-0xc9327e;
mem9x[2].addr-=64;
}
else {
scan(f,buff,&mem95);
if (mem95[2].addr== -1) {reset1(&mem95);wksp[0]^=8;scan(f,buff,&mem95);}
if (mem95[2].addr== -1) return(-2);
mem95[2].addr=mem95[3].addr=mem95[2].addr+0x2c6;
lseek(f,mem95[0].addr+4,0);
if (_read(f,&c,2)<2) goto rerr;
*(int *)(memp01+8)= *(int *)(memp01+16)= *(int *)(memp01+26)=c;
a=mem95[2].addr-mem95[0].addr-5;mem01c[1]=0x900000e8+(a<<8);
a=mem95[2].addr-mem95[1].addr+16;mem02c[1]=(a<<8)-0xc9327e;
mem95[2].addr-=64;
}
...
if (m==1) {
c=scan(f,buff,&realm98);
if (c) return(-2);
}
if (m==3) {
c=scan(f,buff,&realm95);
if (c) {reset1(&realm95);wksp[0]^=8;c=scan(f,buff,&realm95);}
if (c) return(-2);
if (realm95[1].addr>0xffff) return(-2);
realm95[2].addr=realm95[1].addr+0x304;
mgetc95[3]=(mgetc95[3]&0xff0000ff)+((realm95[2].addr-realm95[0].addr-9)<<8);
}
...
x+=z;y+=62;
win98[6].addr=x;tab298ac[9]=x-y;
if (((*(long *)(buff+53))==0) || ((*(long *)(buff+58))==0)) return(-6);
*(long *)(pat9xd+1)=z+20-(*(long *)(buff+53));
*(long *)(pat9xd+7)=(*(long *)(buff+58))+y-x-11;
*(long *)(pat9xd+12)=y-x-16;
if (r3&4) {
win98[6].len= -67;
*(long *)(pat9xd+7)=5;
*(long *)(pat9xd+63)=(*(long *)(buff+58))+y-x-67;
}
...
agp98[0].addr=y;
agp98[2].addr=x+z;
agp981c[3]=agp98[2].addr-agp98[1].addr-5;
if (build(&agp98,list,cnt)) goto bad1;
}
if (build(&realm98,list,cnt)) goto bad1;
if (m16) if (build(&mem9x,list,cnt)) goto bad1;

#ifdef DEMO
if (m16) {
if (build(&dlock,list,cnt)) goto bad1;
if (build(&dlink,list,cnt)) goto bad1;
}
#endif
...
c=scan(f,buff,&win95);
if (c) return(-5);
y=win95[2].addr;lseek(f,y,0);
if (_read(f,buff,51)<51) goto rerr;
x+=z;y+=51;
win95[5].addr=x;tab295ac[9]=x-y;
if (((*(long *)(buff+42))==0) || ((*(long *)(buff+47))==0)) return(-6);
*(long *)(pat9xd+1)=z+0xbda0-(*(long *)(buff+42));
*(long *)(pat9xd+7)=(*(long *)(buff+47))+y-x-11;
*(long *)(pat9xd+12)=y-x-16;
if (r3&4) {
win95[5].len= -67;
*(long *)(pat9xd+7)=5;
*(long *)(pat9xd+63)=(*(long *)(buff+47))+y-x-67;
}
lseek(f,base,0);
if (_read(f,buff,max)<max) goto rerr;
findrel(f,buff,win95[8].addr+2);win95[6].addr=relptr;
findrel(f,buff,win95[8].addr+24);win95[7].addr=relptr;
table95a=z+0x10;table95b=z+0x1d;

#ifdef DEMO
demo95jc[3]=win95[10].addr-win95[9].addr-5;
#endif

#ifdef SELF
if (r3&1) {
c=scan(f,buff,&win95r3);
if (c) return(-7);
if (build(&win95r3,list,cnt)) goto bad1;
}
#endif
...
agp95[0].addr=y;
agp95[2].addr=x+z;
agp951c[3]=agp95[2].addr-agp95[1].addr-5;
if (build(&agp95,list,cnt)) goto bad1;
}
if (build(&realm95,list,cnt)) goto bad1;
if (m16) if (build(&mem95,list,cnt)) goto bad1;
...
if (build(&sigs,list,cnt)) goto bad1;
if (build(&win95,list,cnt)) goto bad1;
}
if (r3&2) {
...
#ifdef SELF
printf("\nWindows 95/98/SE/ME RAM Limitation Patch  Version 7.2 RRL\nCopyright (C) 2007-2013 by Rudolph R. Loew. All Rights Reserved.\n\n");
#endif

#ifdef PRO
printf("\nWindows 95/98/SE/ME RAM Limitation Patch  Version 7.2\nCopyright (C) 2007-2013 by Rudolph R. Loew. All Rights Reserved.\n\n");
#endif

#ifdef DEMO
printf("\nWindows 95/98/SE/ME RAM Limitation Patch  (DEMO)  Version 7.2\nCopyright (C) 2007-2013 by Rudolph R. Loew. All Rights Reserved.\n\n");
#endif
...
badarg:
        ...
        printf("Options:  /A    Move AGP and Unfixed Tables >=128MB to Shared Arena\n");
...
if (exist&2) {
printf("VMM32 File Updated by Other Program - Erase Backup and Continue (Y/N) ? (N) ");
read(0,&i,4);
if ((i&0xdf)-'Y') return(20);
unlink(v3back);exist&=0xfffd;
}
}
_close(f);
}
...
if (exist&0x20) {
printf("VMM File Updated by Other Program - Erase Backup and Continue (Y/N) ? (N) ");
read(0,&i,4);
if ((i&0xdf)-'Y') return(20);
unlink(vback);exist&=0xffdf;
}
}
_close(f);
}
...
if (exist&0x200) {
printf("VCACHE File Updated by Other Program - Erase Backup and Continue (Y/N) ? (N) ");
read(0,&i,4);
if ((i&0xdf)-'Y') return(20);
unlink(cback);exist&=0xfdff;
}
}
_close(f);
}
...
i=procv(f,0x20);
switch(i) {
case 5: rel=comp9x;break;
case 6: rel=compme;break;
case 7: rel=comp9x;break;
...
x=cbase;
if (readx(x,b,0x484)<1) goto badvmr;
...
if (readx(x+132,b,i-260)<1) goto badvcr;
if (_write(f2,b,i-260)<(i-260)) goto badvcw;
x+=z;
while(y) {
i=y;
if (y>0x4000) i=0x4000;
...
if (f<0) {printf("Cannot Open VMM File\n");return(20);}
i=procv(f,vmmflag);
if ((i-1)&0xfffc) {printf("Unknown, Invalid or Compressed VMM File\n");return(20);}
_close(f);
}
reset();
