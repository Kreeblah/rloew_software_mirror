...
0xdb,0xe8,0x8c,0xfd,0x60,0x1e,6,0x1f,7,0x31,0xf6,0xbf,0,7,0xb9,0,
...
d=getnum(v[1]);start=getnum(v[2]);j=0;ld= -1;c--;v++;
}
else {
...
if (blk13ex(0x42,d,start,buff,1)) {
if (blk13ex(0x42,d,start,buff,1)) {
if (blk13ex(0x42,d,start+6,buff,1)) {
...
if (s==0) s=s8;
if (h==0) h=h8;
if (type==32) if (off<2) {printf("Reserved Area must be at least 2 Sectors in FAT32\n");return(20);}
