...
char cr[]="                Encrypted Disk Patch 2.0  Copyright (C) 2006-2013 by Rudolph R. Loew. All Rights Reserved.           ";
...
unsigned char inittb[]={0xb8,0xff,0xff,1,0};               // Call +off[0] mod
...
off[5]=0;
if ((off[0]=find(0L,5,b,init))==0) {
if ((off[0]=find(0L,5,b,inittb))==0) goto bad;
if (find(off[0]+1,5,b,inittb)) goto bad;
*(long *)(patch+0x7a)=0x1ffff;
}
else {
